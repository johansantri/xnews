"""
Django settings for xnews project.
...
SECRET_KEY = 'django-insecure-u@nbx!&yrowh6jtc$pjd+07)5r4+un_zs_c2bq1-5m8de7%mxu'
...
WSGI_APPLICATION = 'xnews.wsgi.application'
